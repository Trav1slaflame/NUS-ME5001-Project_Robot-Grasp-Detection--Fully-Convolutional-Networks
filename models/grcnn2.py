...
filter_sizes = [32, 64, 128, 64, 32, 32]
kernel_sizes = [9, 4, 4, 4, 4, 9]
strides = [1, 2, 2, 2, 2, 1]


class GRCNN2(nn.Module):
    """
    GG-CNN
    ...
    def __init__(self, input_channels=1):
        ...
        self.convt3 = nn.ConvTranspose2d(filter_sizes[4], filter_sizes[5], kernel_sizes[5], stride=strides[5], padding=4)
